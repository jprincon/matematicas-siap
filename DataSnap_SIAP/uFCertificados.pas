...
begin
  ...
  prCedula.Caption := 'con documento de Identificación ' + cedula;

  if tipo = 'Participante' then
    prTitulo.Lines.Text :=
      'Participó en el Workshop EMEM 2019, realizado en Armenia, Quindío del 5 al 8 de Noviembre';

  if tipo = 'Poster' then
    prTitulo.Lines.Text := 'Participó como ponente del Póster "' + titulo +
      '", en el Workshop EMEM 2019, realizado en Armenia, Quindío del 5 al 8 de Noviembre';

  if tipo = 'Stand' then
    prTitulo.Lines.Text := 'Participó con un stand titulado "' + titulo +
      '", en el Workshop EMEM 2019, realizado en Armenia, Quindío del 5 al 8 de Noviembre';

  if tipo = 'Taller' then
    prTitulo.Lines.Text := 'Participó con un Taller titulado "' + titulo +
      '", en el Workshop EMEM 2019, realizado en Armenia, Quindío del 5 al 8 de Noviembre';

  if tipo = 'Ponencia' then
    prTitulo.Lines.Text := 'Participó con la ponencia titulada "' + titulo +
      '", en el Workshop EMEM 2019, realizado en Armenia, Quindío del 5 al 8 de Noviembre';
